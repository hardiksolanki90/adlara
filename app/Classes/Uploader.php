...
class Uploader
{
    ...
    function __construct($uploadName = null) {
        ...
        if ($this->fileName) {
            ...
            $media_type = Context::getContext()->media->getMediaType($pathinfo['extension']);
            $this->uploadDir = Context::getContext()->core->getUploadDir($media_type);
    ...
    public function handleUpload($uploadDir = null, $allowedExtensions = null, $file_size = null) {
        ...
        $this->fileName = Context::getContext()->media->uniqueImageGenerator($this->fileName);
        $this->savedFile = $this->uploadDir . $this->fileName;
